...
# load the dataset and apply MinMaxScaler to the features and target
...
# build a function to train the model and evaluate its performance
...
# train the model with different epochs and print the performance report
...
# identify the best model based on MSE, extract the weights and bias
...
# restore weights and bias to original scale and print the final equation
...
# plot the original data points and the fitted network function in 3D
...
# plot the true data as blue scatter points and the fitted surface as a red plane
